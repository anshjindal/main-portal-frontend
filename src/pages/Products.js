    ...
    <div className="flex justify-center mt-[5vw] mb-[5vw]">
      <div className="w-[80%]">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-left w-[70%] text-[4vw]/[4vw] font-bold">
              Experience Our Cutting-Edge Software Solutions
            </h1>
          </div>
          <div className="w-[55%]">
            <p className="text-left text-[1.1vw]">
        ...
        <div className="flex justify-between text-left items-center border-[#9C9C9C] pt-[2vw] mt-[5vw] mb-[2vw]">
          <div className="flex flex-col gap-y-[2vw]">
            ...
            <div className="flex border-[#9C9C9C] border-l-[0.1vw] h-[7vw] w-[25vw] text-[1.3vw] text-[#787878] pl-[1vw] ml-[2.8vw] items-center">
          ...
          <div
            className="w-[30vw] h-[35vw] bg-cover bg-[center_right_-2vw]"
