...
const OurApproachData = {
  en: [
    ...
    },
    {
      ...
      hoverTitle: 'Collaborative Partnership',
      hoverContent:
        'We offer support and maintenance services for the sustained functionality of digital marketing strategies and the software solutions we develop. We also have a support team who is always on hand to help with any requirements or issues that you may have.',
    },
    {
      image: OurApproachContinuousImprovement,
      title: 'Continuous',
      subtitle: 'Improvement',
      hoverTitle: 'Continuous Improvement',
      hoverContent:
