...
function Navbar() {
  ...
  return (
    <>
      <div className="flex justify-center navbar max-[450px]:hidden">
        <div className="flex items-center justify-center h-[8vw] mb-[3vw] border-b-[0.001vw] text-[#2B00AC] border-[#B8B8B8] max-[450px]:w-[80%] max-[450px]:border-none max-[450px]:pt-[13vw] max-[450px]:pb-[9vw]">
          ...
          <Link to={`/${currentLang}/ContactUs`}>
            <div className="max-[450px]:hidden w-[8vw] h-[3vw] rounded-full border-[0.1vw] z-10 border-[#2B00AC] hover:bg-[#0033A0] hover:text-[#FFFFFF] text-[#2B00AC] text-[1.2vw] flex items-center justify-center transition-all duration-300 ease-in-out relative shadow-inner hover:shadow-inner-custom">
              {Content.letstalk}
