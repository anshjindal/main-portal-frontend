...
import rawContent from '../../content/AboutUs/WorkerTestimonial.json';
...
type WorkerTestimonialData = {
  en: TestimonialContent;
  fr: TestimonialContent;
};

type WorkerTestimonialProps = {
  lang: 'en' | 'fr';
};
const content = rawContent as WorkerTestimonialData;


function WorkerTestimonial({ lang }: WorkerTestimonialProps): JSX.Element {
      ...
      <div className="flex justify-center w-[80%]">
        ...
        <div>
          ...
          <div className="flex justify-center items-center text-left w-[35vw] h-[27vw] bg-white ml-[-4vw]">
            <div className="p-[3vw]">
              <h1 className="text-[3vw]/[3vw] font-bold">{Content.title}</h1>
              <p className="text-[1.1vw] mt-[1.5vw]">{Content.testimonial}</p>
