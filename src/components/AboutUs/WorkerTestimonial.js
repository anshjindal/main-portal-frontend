        ...
        <div className="flex justify-center items-center text-left w-[35vw] h-[27vw] bg-white ml-[-4vw]">
          <div className="p-[3vw]">
            ...
            <p className="text-[1.1vw] mt-[1.5vw]">
              I’ve been provided with the opportunity to expand my
              skillset through the endless support, and choice in varying
              projects. I’ve had a great experience so far and am excited
