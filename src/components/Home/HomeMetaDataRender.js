...
import content from "../../content/Home/HomeMetaData.json";

const HomeMetaRender = ({ lang }) => {
  ...
  return (
    <>
       <Helmet>
        ...
        <link rel="canonical" href="https://www.wouessi.com/en/"></link>
