            ...
            <form>
              <div className="flex items-center border-b-[0.4vw] border-[#B8B8B8]">
                <input
                  ...
                  placeholder="Email*"
                  required
                  className="bg-[#2B00AC] h-[3.5vw] w-full text-[1.2vw] focus-visible:outline-none placeholder:font-normal placeholder:text-white max-[450px]:text-[2.5vw] max-[450px]:h-[5vw]"></input>
                <button
                  type="submit"
