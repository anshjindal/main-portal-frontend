...
function WorkWithUs({ Heading, CallToAction }) {
  return (
    <div className="flex text-left justify-center items-center pt-[8vw] mb-[6vw]">
      ...
      <div className="border-black border-[0.1vw] hover:bg-[#2703A5] hover:text-white transition ease-in-out rounded-full flex items-center justify-center mt-[1vw] ml-[6vw] gap-x-[0.3vw] w-[14vw] h-[14vw] text-[1.1vw] cursor-pointer">
        {CallToAction}
